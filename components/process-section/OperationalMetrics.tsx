...
export function TodayMetrics({ dateRange = "30d" }: MetricProps) {
  ...
  return (
    <div className="bg-white border border-border rounded-lg shadow-sm p-3 h-full flex flex-col transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md hover:border-border-subtle">
      ...
      <div className="grid grid-cols-2 gap-3 flex-1">
        <div className="bg-white border border-border/50 rounded-lg p-3 flex flex-col justify-between">
          ...
          <span className="font-semibold text-xl text-foreground tracking-tight"><AnimatedValue value={Math.round(120 * m).toString()} /></span>
        </div>
        <div className="bg-white border border-border/50 rounded-lg p-3 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">  
          ...
          <span className="font-semibold text-xl text-foreground tracking-tight"><AnimatedValue value={Math.round(104 * m).toString()} /></span>
        </div>
        <div className="bg-white border border-border/50 rounded-lg p-3 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
          ...
          <span className="font-semibold text-xl text-foreground tracking-tight"><AnimatedValue value={Math.round(96 * m).toString()} /></span>
        </div>
        <div className="bg-white border border-border/50 rounded-lg p-3 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
          ...
          <span className="font-semibold text-xl text-foreground tracking-tight"><AnimatedValue value={Math.round(8 * m).toString()} /></span>
        </div>
      </div>
    </div>
  )
    ...
    <div className="bg-white border border-border rounded-lg shadow-sm p-3 h-full flex flex-col transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md hover:border-border-subtle">
      ...
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-[auto_1fr_auto_auto] gap-x-3 items-center text-xs">
          ...
          <span className="font-medium text-foreground text-right whitespace-nowrap"><AnimatedValue value={Math.round(640 * m).toString()} /> units</span>
        ...
        <div className="grid grid-cols-[auto_1fr_auto_auto] gap-x-3 items-center text-xs">
          ...
          <span className="font-medium text-foreground text-right whitespace-nowrap"><AnimatedValue value={Math.round(520 * m).toString()} /> units</span>
          <span className="w-10 text-center text-[10px] font-bold text-emerald-700 bg-emerald-50 px-1 py-0.5 rounded">OK</span>
        </div>
        <div className="grid grid-cols-[auto_1fr_auto_auto] gap-x-3 items-center text-xs">
          <Package className="w-4 h-4 text-foreground shrink-0" />
          <span className="text-foreground-muted whitespace-nowrap font-medium">Packaging</span>
          <span className="font-medium text-foreground text-right whitespace-nowrap"><AnimatedValue value={Math.round(84 * m).toString()} /> units</span>
        ...
        <div className="grid grid-cols-[auto_1fr_auto_auto] gap-x-3 items-center text-xs">
          ...
          <span className="font-medium text-foreground text-right whitespace-nowrap"><AnimatedValue value={Math.round(140 * m).toString()} /> units</span>
          <span className="w-10 text-center text-[10px] font-bold text-emerald-700 bg-emerald-50 px-1 py-0.5 rounded">OK</span>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white border border-border rounded-lg shadow-sm p-3 h-full flex flex-col transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md hover:border-border-subtle">
      ...
      <div className="flex flex-col gap-2.5">
        <div className="flex justify-between items-center text-[11px]">
          ...
          <span className="font-semibold text-base text-foreground leading-none"><AnimatedValue value={Math.round(104 * m).toString()} /></span>
        </div>
        <div className="flex justify-between items-center text-[11px]">
          <span className="text-foreground-muted font-medium">Passed</span>
          <span className="font-semibold text-base text-foreground leading-none"><AnimatedValue value={Math.round(96 * m).toString()} /></span>
        </div>
        <div className="flex justify-between items-center text-[11px]">
          <span className="text-foreground-muted font-medium">Rejected</span>
          <span className="font-semibold text-base text-foreground leading-none"><AnimatedValue value={Math.round(8 * m).toString()} /></span>
        </div>
        <div className="flex justify-between items-end text-xs mt-1 pt-2 border-t border-border">
          ...
          <span className="font-semibold text-xl text-foreground leading-none"><AnimatedValue value={dateRange === "7d" ? "94.2%" : dateRange === "90d" ? "91.5%" : "92.3%"} /></span>
        </div>
      </div>
    </div>
  )
...
export function DispatchMetrics({ dateRange = "30d" }: MetricProps) {
  ...
  return (
    <div className="bg-white border border-border rounded-lg shadow-sm p-3 h-full flex flex-col justify-between relative overflow-hidden transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md hover:border-border-subtle">
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-col items-center justify-center flex-1 gap-1 text-center mt-1">
          ...
          <span className="text-[13px] font-semibold text-foreground leading-tight"><AnimatedValue value={units.toString()} /> units ready</span>
