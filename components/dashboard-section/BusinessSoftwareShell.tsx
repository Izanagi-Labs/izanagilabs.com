...
export function BusinessSoftwareShell({ 
  ...
  return (
    <div className={`bg-background border border-border shadow-md rounded-xl flex overflow-hidden font-sans relative z-10 ${heightClass}`}>
      <DashboardSidebar activeTab={activeTab} compact={compactSidebar} />
      <div className="flex-1 flex flex-col min-w-0 bg-surface">
        <div className="p-4 lg:px-6 lg:py-5 flex-1 flex flex-col overflow-y-auto">
          {children}
        </div>
      </div>
    </div>
