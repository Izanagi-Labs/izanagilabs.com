  ...
  return (
    <section id="contact" className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-24 xl:py-32 relative overflow-hidden">
      ...
      <div className="hidden xl:flex absolute top-12 left-[12%] transform -rotate-6 z-20 flex-col items-center pointer-events-none" aria-hidden="true">
        ...
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-foreground-fainter mt-2 ml-16">
      ...
      <div className="hidden xl:flex absolute top-8 right-[5%] transform -rotate-3 z-20 flex-col items-end pointer-events-none" aria-hidden="true">
        ...
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-foreground-fainter mt-2 mr-48 -scale-x-100">
          <path d="M4 4C4 4 20 6 30 20C30 20 22 20 22 20M30 20C30 20 30 12 30 12" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-10 xl:gap-24 justify-between items-start relative z-10 mx-auto max-w-7xl">
        ...
        <div className="w-full lg:w-[40%] xl:w-[35%] shrink-0 flex flex-col pt-8 xl:pt-16">
          ...
          <div className="flex flex-col gap-6 w-full relative">
            ...
            <div className="flex items-center gap-4">
              <span className="text-label text-foreground-faint whitespace-nowrap">08</span>
              <div className="w-12 h-px bg-foreground-faint" />
              <span className="text-label text-foreground-faint whitespace-nowrap">CONTACT US</span>
            </div>
            ...
            <div className="mt-2">
              <button 
                ...
                className="inline-flex items-center text-system-sm font-semibold text-danger transition-colors group tracking-widest uppercase border-b border-danger pb-2">
                SEND ENQUIRY 
        ...
        <div className="w-full lg:w-[60%] xl:w-[58%] relative flex-1">
          <div className="border border-border rounded-sm bg-transparent p-6 lg:p-8">
            <span className="text-label text-foreground-faint whitespace-nowrap mb-4 block">START THE CONVERSATION</span>
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit} noValidate>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input 
                  ...
                  className={`w-full px-4 py-2.5 bg-transparent border ${errors.name ? 'border-danger' : 'border-border'} rounded-sm focus:outline-none focus:border-foreground transition-colors text-body-md placeholder:text-foreground-fainter`}
                />
              ...
              <div className="flex flex-col gap-2">
                ...
                <input 
                  ...
                  className={`w-full px-4 py-2.5 bg-transparent border ${errors.email ? 'border-danger' : 'border-border'} rounded-sm focus:outline-none focus:border-foreground transition-colors text-body-md placeholder:text-foreground-fainter`}
                />
              ...
              <div className="flex flex-col gap-2">
                ...
                <input 
                  ...
                  className={`w-full px-4 py-2.5 bg-transparent border ${errors.phone ? 'border-danger' : 'border-border'} rounded-sm focus:outline-none focus:border-foreground transition-colors text-body-md placeholder:text-foreground-fainter`}
                />
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  ...
                  rows={3}
                  className={`w-full px-4 py-2.5 bg-transparent border ${errors.message ? 'border-danger' : 'border-border'} rounded-sm focus:outline-none focus:border-foreground transition-colors text-body-md placeholder:text-foreground-fainter resize-none`}
                />
              ...
              <div className="mt-2 flex flex-col items-start gap-4">
                <button 
                  ...
                  className={`inline-flex items-center text-system-sm font-semibold transition-colors group tracking-widest uppercase border-b pb-2 ${status === "submitting" ? 'text-foreground-muted border-foreground-muted cursor-not-allowed' : 'text-danger border-danger cursor-pointer'}`}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center w-full relative z-10 max-w-7xl mx-auto  xl:mt-32">
          ...
          <div className="hidden xl:flex absolute -top-35 left-[70%] flex-col items-center transform -rotate-6 pointer-events-none" aria-hidden="true">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="text-foreground-fainter mb-2 mr-16">
