        ...
        <div className="w-full lg:w-[40%] xl:w-[35%] shrink-0 flex flex-col pt-8 xl:pt-16">
          ...
          <div className="flex flex-col gap-6 w-full relative">
            ...
            <div className="mt-2 flex flex-row items-center gap-6">
              <a
                href="https://wa.me/7892374173?text=Hi%20Izanagi%20Labs%2C%20I%27d%20like%20to%20discuss%20a%20project."
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Chat with Izanagi Labs on WhatsApp (opens in new tab)"
                className="inline-flex items-center gap-2 text-system-sm font-semibold text-foreground-muted hover:text-foreground transition-colors group tracking-widest uppercase border-b border-[#25D366] pb-2 w-fit"
              >
                {/* WhatsApp icon */}
                <svg
                  aria-hidden="true"
              ...
              <span className="text-system-md text-foreground-fainter tracking-widest lowercase">or</span>
